...
class SettingPageController extends GetxController {
  ...
  void toogleSarapan() async {
    ...
    if (sarapanToggle.value) {
      ...
      NotificationsApi.cancelNotification(1).then((value) => Get.snackbar(
  ...
  Future<void> toogleSiang() async {
    ...
    if (siangToggle.value) {
      await NotificationsApi.scheduledNotification(
        id: 2,
      ...
      NotificationsApi.cancelNotification(2).then((value) {
  ...
  void toogleMalam() {
    ...
    if (malamToggle.value) {
      ...
      NotificationsApi.cancelNotification(3).then((value) {
